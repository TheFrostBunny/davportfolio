...
export default function TimelineSection() {
  ...
  return (
    <section id="journey" className="relative py-32 bg-background/30">
      <div className="container max-w-4xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 via-purple-500 to-blue-500" />

          {/* Timeline events - single column */}
            ...
            {t.events.map((event, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`relative flex ${isEven ? 'flex-row' : 'flex-row-reverse'} items-center gap-8 md:gap-12`}
                >
                  {/* Content card */}
